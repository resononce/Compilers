...
public class Main {
	...
	// finally, resize inFiles to the # of specified input files (i.e., cnt)
	String[] tmp = inFiles;
    ...
    /** Main method, which drives compilation
      * builds and runs each phase of the compiler (stops at parsing for A3)
      * @param args list of commandline arguments 
      * */
	...
	try 
	{
	    ...
	    Parser parser = new Parser(inFiles, true);
