...
*/
  ...
  int lineNum = JavaCharStream.getBeginLine();
    ...
    default:
      ...
      else if (andOp.toString() == "&&") {
        {if (true) return new BinaryLogicAndExpr(lineNum, e1, e2);}
      }
    throw new Error("Missing return statement in function");
  }
  ...
  int lineNum = JavaCharStream.getBeginLine();
    ...
    default:
      ...
      if (eqOp == null) {
        ...
        {if (true) return new BinaryCompEqExpr(lineNum, e1, e2);}
      }
      else if (eqOp.toString() == "!=") {
        {if (true) return new BinaryCompNeExpr(lineNum, e1, e2);}
      }
    throw new Error("Missing return statement in function");
  }
  ...
  int lineNum = JavaCharStream.getBeginLine();
    ...
    default:
      ...
      if (compOp == null) {
        ...
        {if (true) return new BinaryCompGtExpr(lineNum, e1, e2);}
      }
      else if (compOp.toString() == "<") {
        {if (true) return new BinaryCompLtExpr(lineNum, e1, e2);}
      }
      else if (compOp.toString() == ">=") {
        {if (true) return new BinaryCompGeqExpr(lineNum, e1, e2);}
      }
      else if (compOp.toString() == "<=") {
        {if (true) return new BinaryCompLeqExpr(lineNum, e1, e2);}
      }
    throw new Error("Missing return statement in function");
  }
  ...
  int lineNum = JavaCharStream.getBeginLine();
    ...
    case LEFTPAREN:
      ...
      // Cheng newbie change this part e1 = new VarExpr(lineNum, e1, name)
  ...
  int lineNum = JavaCharStream.getBeginLine();
    ...
    case DOT:
      ...
      // Cheng newbie change this part e = new VarExpr(lineNum, leftExpr, name.image.toString())
      if (e1 != null) {
  ...
  int lineNum = JavaCharStream.getBeginLine(); ExprList el = new ExprList(lineNum);
    ...
    case ID:
      e = Expr();
      //el = new ExprList(lineNum); Initialized expression list above so it won't be null below
      el.addElement(e);
      label_11:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
