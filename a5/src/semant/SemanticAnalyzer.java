...
public class SemanticAnalyzer {
    ...
    private void buildClassTree(ClassList classList)
    {
		...
		classMap.get("String").setParent(classMap.get("Object"));
		classMap.get("Sys").setParent(classMap.get("Object"));
		classMap.get("TextIO").setParent(classMap.get("Object"));
    ...
    private void checkMain()
    {
		if (classMap.containsKey("Main")) {
			if (classMap.get("Main").getMethodSymbolTable().getSize() == 0
				|| classMap.get("Main").getMethodSymbolTable()
				.lookup("main") == null) {
